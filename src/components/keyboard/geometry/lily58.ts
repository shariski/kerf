...
const leftKeys: KeyGeometry[] = [
  ...
  { char: " ",      label: "spc",  x: 174, y: 158, width: W, height: H, rotate: 15, rotateOrigin: CENTER },
  { char: "rse_l",  label: "rse",  x: 214, y: 170, width: W, height: H, rotate: 15, rotateOrigin: CENTER },
];
...
const rightKeys: KeyGeometry[] = [
  ...
  { char: "rse_r",   label: "rse",  x: -40, y: 170, width: W, height: H, rotate: -15, rotateOrigin: CENTER },
  { char: "space_r", label: "spc",  x: 0,   y: 158, width: W, height: H, rotate: -15, rotateOrigin: CENTER },
